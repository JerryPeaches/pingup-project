                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700'>
                            ...
                            <div className='group/profile relative hover:cursor-pointer'>
                    ...
                    <div className='flex flex-col items-start gap 3'>
                        <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/cover relative hover:cursor-pointer'>
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray200 rounded-lg' placeholder='Please enter your full name' onChange={(e)=>setEditForm({...editForm, full_name: e.target.value})} value={editForm.full_name}/>
                    </div>
                    <div>
                        <label htmlFor="" className='block text-sm font-medium text-gray-700 mb-1'>
                            Username
                        </label>
                        <input type="text" className='w-full p-3 border border-gray200 rounded-lg' placeholder='Please enter a username' onChange={(e)=>setEditForm({...editForm, username: e.target.value})} value={editForm.username}/>
                    </div>
                    <div>
                        <label htmlFor="" className='block text-sm font-medium text-gray-700 mb-1'>
                            Bio
                        </label>
                        <textarea rows={3} className='resize-none w-full p-3 border border-gray200 rounded-lg' placeholder="Say something about yourself... Or don't!" onChange={(e)=>setEditForm({...editForm, bio: e.target.value})} value={editForm.bio}/>
                    </div>
                    <div>
                        <label htmlFor="" className='block text-sm font-medium text-gray-700 mb-1'>
                            <span className='flex items-center gap-1'><MapPin className='w-4 h-4'/> Location</span>
                        </label>
                        <input type="text" className='w-full p-3 border border-gray200 rounded-lg' placeholder='Where are you from?' onChange={(e)=>setEditForm({...editForm, location: e.target.value})} value={editForm.location}/>
                    </div>
