        ...
        <div className='max-w-3xl mx-auto'>
            ...
            <div className='bg-white rounded-2xl shadow overflow-hidden'>
                ...
                <div className='h-40 md:h-46 bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200'>
                    {user.cover_photo && <img src={user.cover_photo} alt={`${user.full_name}'s Cover Photo`} className='w-full h-full object-cover'/>}
                </div>
                {/* User Info */}
            ...
            <div className='mt-6'>
                <div className='bg-white rounded-xl shadow p-1 flex max-w-md mx-auto'>
                    {["posts", "media", "likes"].map((tab)=>(
                        <button key={tab} className={`flex-1 px-4 py-2 text-sm font-medium rounded-lg transition-colors cursor-pointer ${activeTab === tab ? "bg-indigo-600 text-white" : "text-gray-600 hover:text-gray-900"}`} onClick={()=> setActiveTab(tab)}>
